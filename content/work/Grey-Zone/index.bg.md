...
medium = ["едноканална видео инсталция, 04:15 мин.", "3D китбаш фотограметрия", "видео игра"]
...
youtubeNames = [
  "Сива зона / Диспозитив, 2022 | Никола Стоянов",
]
youtubeDescrps = [
...
„Сива зона / Диспозитив“ е масивна фотограметрия, възпроизвеждаща градското пространство на Варна, България. Обхващаща реална площ от около 3 квадратни километра, тя се базира на сателитни изображения на града и представя неговия двойник. Видеоинсталацията разчита и на авангарден AI-денуализатор - технология, чиито артефакти допринасят за изкривяване на визуалното поле в съноподобна акварелна рисунка. Първоначалната версия на "Сива зона" / "Диспозитив" под формата на видеоинсталация беше представена като част от изложбата "Временна криза", част от [Sofia Underground](https://sofiaunderground.com/%d0%b0%d1%80%d1%85%d0%b8%d0%b2/su-x0xx/) (2022). По-късно разработена в видеоигра като част от изложбата ["РЕ:Процес"](https://newdegeneration.xyz/work/re-process/) в град Варна (продължение на изложбата ["В Процес"](https://newdegeneration.xyz/work/in-process/), 2021).
