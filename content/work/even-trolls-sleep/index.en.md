...
imgNames = [
    "Even trolls sleep sometimes Nikola Stoyanov",
    "Even trolls sleep sometimes Nikola Stoyanov",
    "Even trolls sleep sometimes Nikola Stoyanov",
    "Even trolls sleep sometimes Nikola Stoyanov",    
    "Even trolls sleep sometimes Nikola Stoyanov",
...
imgDescrps = [
    "Installation view with 70x37 cm. LED TV attach to iPhone 11 livestreaming a Telegram Clone.",
    "Chat messages and reactions get updated in real-time based on the downloaded chat history of the users. Some images have been scrubbed for regulatory reasons. The chat covers roughly 24 hours of activity around the doxing event.",
    "Exhibition opening night.",
    "Installation view showing various sticker based prominent Bulgarian celebrities and politicians. Its important to mention that these rarely present an endorsement or attack and are mainly used for their comical character.",    
    "Exhibition view during curators tour showing pieces by (left to right)  Nikola Andreev, Marina Genova, Kiril Bukovski, Yana Fendulova (bottom).",
    "",
    "",
    "Live image of artist personal information being leaked to a pro-Russian, far-right chat group. The caption reads  „4000 levs from the National Culture Fund for the dissemination of satanic and occult symbols.“"
]
